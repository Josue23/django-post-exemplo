...
urlpatterns = [
    ...
    url(r'^aluno/(?P<pk>\d+)/delete/confirm/$', v.aluno_delete_confirm, name='aluno_delete_confirm'),
    ...
    url(r'^professor/(?P<pk>\d+)/delete/$', v.professor_delete, name='professor_delete'),
    url(r'^professor/(?P<pk>\d+)/delete/confirm/$', v.professor_delete_confirm, name='professor_delete_confirm'),
